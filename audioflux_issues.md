...
(MIT licensed) C sources directly into `src/third_party/audioflux/`, instead of
...
**Files vendored (resample-only, so far):** see `src/third_party/audioflux/README.md`
...
```c
// patched (src/third_party/audioflux/src/dsp/resample_algorithm.c)
